<h2 id="Folders">Contents of the code</h2> 
...
- **3 Decomposition**
- **4 Convert QUBO to Ising model for QAOA**

<h2 id="Folders">Requirements</h2> 

- biopython
- pyqubo
- dwave-hybrid (for decomposition)
- dwave-ocean-sdk
- qiskit-optimization (convert QUBO to Ising model for QAOA)
